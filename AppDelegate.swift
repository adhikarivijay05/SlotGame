...
//[self solution:myIntegers];

//-(int)solution:(NSMutableArray * )A {
//    // write your code in Objective-C 2.0
//    NSPredicate * predicate = [NSPredicate predicateWithFormat:@"integerValue >= 0"];
//    NSArray * positiveNumbers = [A filteredArrayUsingPredicate:predicate];
//    NSLog(@"  after Remove  %lu", (unsigned long)[positiveNumbers count]);
//    int sum = 0;
//    for (int i = 0; i < A.count; i ++) {
//        
//        NSNumber * value = A[i];
//        int val = [value intValue];
//        int x = (int)pow(2, (double)val);
//        sum += x;
//    }
//    
//    NSLog(@"  after Remove  %d", sum);
//    return sum;
//    
//}
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "SlotGame")
